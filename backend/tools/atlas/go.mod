module github.com/hiamthach108/keyloop-challenge/backend/tools/atlas

go 1.25.0

require ariga.io/atlas-provider-gorm v0.6.1

require github.com/hiamthach108/keyloop-challenge/backend v0.0.0

replace github.com/hiamthach108/keyloop-challenge/backend => ../..
